...
We've done car camping plenty of times before so we had a lot of the necessary equipment already. My wife also had a Jansport Klamath 2 85l backpack from backpacking in Asia we'd use as the
main backpack. I'd carry it while my wife would carry some additional water and extra cloth in my work backpack.
...
* Food: Usually we bring a huge cooler and camping grill and make sandwiches for lunch and BBQ for dinner. Not really an option for a thru-hike. So we stocked up on protein bars, dried prunes,
...
* [Wenzel Ridgeline 3 Tent](http://www.amazon.com/gp/product/B002PB2HBW?psc=1&redirect=true&ref_=oh_aui_detailpage_o01_s00): Heavy but I didn't want to buy another tent.
...
When we checked in at the campground we also purchased our Ohlone Trail Permits (required) for $2 each. The permits also contain a map of the entire trail so they're well worth that. Most people
...
the map and see how far we've gotten. Only at 1190 feet elevation and 1 mile into the official trail. Ouch.

![Ohlone sign-in panel]({{ site.url }}/img/hikes/ohlone/3.jpg)
*Ohlone sign-in panel*

![Ohlone sign-in panel]({{ site.url }}/img/hikes/ohlone/4.jpg)
*Ohlone sign-in panel*
...
Megan wanted to watch the sunset outside our tent and see the stars but I was so exhausted that I passed out before that.
...
flat and we made good progress. It also helped that we carried only 3l of water because there would be plenty of spots we can refill at available during the day.
...
Up until that point direction signs have been great the entire trail. But when we reached Mission Peak Park we must've taken a wrong turn and accidentally ended up on Mill Creek Road. We really
didn't want to try and backtrack at this point so we decided to carry on and use the Peak Trail from Mill Creek Road to get back on to the Ohlone Trail. Unfortunately that also meant 500 ft
unnecessary elevation gain before we finally reached the trail again and began our descend into Fremont.
